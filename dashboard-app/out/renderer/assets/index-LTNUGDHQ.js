...
if (typeof window !== "undefined") {
  const vibemind = window.vibemind;
  if (vibemind?.onEngineLog) {
    vibemind.onEngineLog((logLine) => {
      if (logLine) {
  ...
  if (vibemind?.onEngineProgress) {
    vibemind.onEngineProgress((data) => {
      if (!data) return;
      ...
      if (typeof total_tasks === "number" && total_tasks > 0) {
        ...
        const running = Math.min(5, total_tasks - completed - failed);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "h-screen flex flex-col bg-engine-darker", children: [
    ...
    activeView === "projects" ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 flex overflow-hidden", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("main", { className: "flex-1 flex flex-col overflow-hidden", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "shrink-0 max-h-48 overflow-auto border-b border-gray-700", children: /* @__PURE__ */ jsxRuntimeExports.jsx(ProjectSpace, {}) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-1 overflow-hidden", children: /* @__PURE__ */ jsxRuntimeExports.jsx(GenerationMonitor, {}) })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("aside", { className: "w-[520px] bg-engine-dark border-l border-gray-700 flex flex-col", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: previewProjectId ? "flex-1 min-h-0" : "flex-1 min-h-0 flex items-center justify-center text-gray-600", children: previewProjectId ? /* @__PURE__ */ jsxRuntimeExports.jsx(LivePreview, {}) : /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm", children: "No preview active" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-64 border-t border-gray-700 overflow-hidden", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
          VibeChat,
          {
